...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    expect {Dessert.new("cookie", "ode", chef)}.to raise_error(ArgumentError)
    end 
  end

  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do 
      cookie.add_ingredient("fudge")
      expect(cookie.ingredients).to include("fudge")
    end 
  end
  ...
  describe "#mix!" do
    ...
    it "shuffles the ingredient array" do 
        ingredients = ["fudge", "flour", "egg", "sugar", "butter"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cookie.serve).to eq("Chef Tucker the Great Baker has made 100 cookies!")
    end
  end
